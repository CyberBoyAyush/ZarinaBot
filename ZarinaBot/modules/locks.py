...
import ZarinaBot.modules.sql.locks_sql as sql
from ZarinaBot import dispatcher, DRAGONS, LOGGER
        ...
        if len(args) >= 1:
            ...
            if ltype in LOCK_TYPES:
                ...
                if conn:
                    ...
                    chat_id = conn
                    chat_name = chat.title
                    text = "Unlocked {} for everZarinaBot in {}!".format(ltype, chat_name)
                else:
                    if update.effective_message.chat.type == "private":
                        send_message(
                            update.effective_message,
                    ...
                    chat_id = update.effective_chat.id
                    chat_name = update.effective_message.chat.title
                    text = "Unlocked {} for everZarinaBot!".format(ltype)
