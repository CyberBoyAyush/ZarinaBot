...
import ZarinaBot.modules.sql.notes_sql as sql
from ZarinaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ZarinaBot.__main__ import DATA_IMPORT
from ZarinaBot.modules.helper_funcs.chat_status import user_admin
from ZarinaBot.modules.helper_funcs.alternate import typing_action

# from ZarinaBot.modules.rules import get_rules
import ZarinaBot.modules.sql.rules_sql as rulessql

# from ZarinaBot.modules.sql import warns_sql as warnssql
import ZarinaBot.modules.sql.blacklist_sql as blacklistsql
from ZarinaBot.modules.sql import disable_sql as disabledsql

# from ZarinaBot.modules.sql import cust_filters_sql as filtersql
# import ZarinaBot.modules.sql.welcome_sql as welcsql
import ZarinaBot.modules.sql.locks_sql as locksql
from ZarinaBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("ZarinaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ZarinaBot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ZarinaBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ZarinaBot{}.backup".format(chat_id))  # Cleaning file
