...
import ZarinaBot.modules.sql.global_bans_sql as gban_sql
import ZarinaBot.modules.sql.users_sql as user_sql
from ZarinaBot import DEV_USERS, OWNER_ID, dispatcher
