...
from ZarinaBot.modules.helper_funcs.msg_types import Types
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} just joined. EverZarinaBot, look busy!",
    ...
    "EverZarinaBot stop what you’re doing, We are now in the presence of {first}.",
