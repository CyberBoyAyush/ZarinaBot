...
from ZarinaBot.modules.disable import DisableAbleMessageHandler
from ZarinaBot.modules.helper_funcs.regex_helper import infinite_loop_check
    ...
    if sed_result and update.effective_message.reply_to_message:
        ...
        try:
            ...
            if check and check.group(0).lower() == to_fix.lower():
                update.effective_message.reply_to_message.reply_text(
                    "Hey everZarinaBot, {} is trying to make "
