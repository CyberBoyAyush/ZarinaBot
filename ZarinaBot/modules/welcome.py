...
import ZarinaBot.modules.sql.welcome_sql as sql
import ZarinaBot
...
from ZarinaBot.modules.helper_funcs.msg_types import get_welcome_type
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll go loaf around and not welcome anZarinaBot then."
            )
