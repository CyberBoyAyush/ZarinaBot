...
from ZarinaBot import LOGGER, DRAGONS, TIGERS, WOLVES, dispatcher
...
from ZarinaBot.modules.sql import reporting_sql as sql
    ...
    if chat.type == chat.PRIVATE:
        if len(args) >= 1:
            if args[0] in ("yes", "on"):
                ...
                msg.reply_text(
                    "Turned on reporting! You'll be notified whenever anZarinaBot reports something."
                )
