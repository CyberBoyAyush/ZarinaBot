...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import ZarinaBot.events

        path = Path(f"ZarinaBot/modules/{shortname}.py")
        name = "ZarinaBot.modules.{}".format(shortname)
        ...
        mod.ZarinaBot = ZarinaBot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["ZarinaBot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "ZarinaBot/modules/*.py"
